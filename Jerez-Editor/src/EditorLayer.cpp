...
namespace Huiluna {
	...
	void EditorLayer::UI_Toolbar()
	{
		...
		ImGui::SameLine();
		{
			...
			if (ImGui::ImageButton("imageButton2", (ImTextureID)icon->GetRendererID(), ImVec2(size, size)))
			{
	...
	{
		HL_CORE_ASSERT(m_SceneState == SceneState::Play || m_SceneState == SceneState::Simulate, "");
